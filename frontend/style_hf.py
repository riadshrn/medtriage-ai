...
def apply_style():
    ...
    # CSS minimal compatible HF Spaces
    css = """
    <style>
        ...
        .triage-rouge { background: linear-gradient(135deg, #DC2626, #B91C1C); }
        .triage-jaune { background: linear-gradient(135deg, #F59E0B, #D97706); }
        .triage-vert { background: linear-gradient(135deg, #10B981, #059669); }
        .triage-gris { background: linear-gradient(135deg, #6B7280, #4B5563); }
...
# Ancienne fonction apply_style_full (gardée pour référence locale)
def apply_style_full():
    """Version complete du CSS (pour usage local)."""
